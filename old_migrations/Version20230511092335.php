 ...
 */
final class Version20230511092335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE region ADD region_id INT NOT NULL, ADD visiteur_id INT NOT NULL');
        $this->addSql('ALTER TABLE region ADD CONSTRAINT FK_F62F17698260155 FOREIGN KEY (region_id) REFERENCES region (id)');
        $this->addSql('ALTER TABLE region ADD CONSTRAINT FK_F62F1767F72333D FOREIGN KEY (visiteur_id) REFERENCES visiteur (id)');
        $this->addSql('CREATE INDEX IDX_F62F17698260155 ON region (region_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE region DROP FOREIGN KEY FK_F62F17698260155');
        $this->addSql('ALTER TABLE region DROP FOREIGN KEY FK_F62F1767F72333D');
        $this->addSql('DROP INDEX IDX_F62F17698260155 ON region');
        $this->addSql('DROP INDEX IDX_F62F1767F72333D ON region');
        $this->addSql('ALTER TABLE region DROP region_id, DROP visiteur_id');
